          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {features.map((f, i) => (
                <div
                  key={i}
                  className="p-8 rounded-2xl bg-white border border-gray-100 hover:border-primary-200 hover:shadow-md transition-all duration-200 hover:-translate-y-1"
                >
            ...
            {testimonials.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {testimonials.map((t, idx) => (
                  <div
                    key={t.id}
                    className="bg-surface p-8 rounded-2xl border border-gray-100 hover:shadow-md transition-all duration-200 hover:-translate-y-1 flex flex-col"
                  >
                    {/* Estrellas */}
        ...
        <section className="py-20 bg-gradient-to-br from-gray-900 to-gray-800">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-gray-400 mb-8">
              Accede a tu cuenta para agendar citas, ver tu plan de tratamiento y mucho más.
            </p>
            <Link
              href="/login"
              className="inline-flex items-center justify-center px-8 py-4 bg-cta-500 hover:bg-cta-600 text-white font-semibold rounded-lg transition-all hover:-translate-y-0.5 hover:shadow-lg"
            >
              Agendar mi cita <ArrowRight className="ml-2 h-5 w-5" />
            </Link>
          </div>
        </section>
